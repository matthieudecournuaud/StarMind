...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.nova.star.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.nova.star.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.nova.star.domain.User.class.getName());
            createCache(cm, com.nova.star.domain.Authority.class.getName());
