...
import { sampleWithRequiredData } from '../global-chat.test-samples';
import { GlobalChatService } from '../service/global-chat.service';

import { GlobalChatComponent } from './global-chat.component';
import SpyInstance = jest.SpyInstance;

describe('GlobalChat Management Component', () => {
  let comp: GlobalChatComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(GlobalChatComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.globalChats?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to globalChatService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getGlobalChatIdentifier');
      const id = comp.trackId(entity);
      expect(service.getGlobalChatIdentifier).toHaveBeenCalledWith(entity);
