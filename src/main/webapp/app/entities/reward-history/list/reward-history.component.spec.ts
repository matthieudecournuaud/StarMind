...
import { sampleWithRequiredData } from '../reward-history.test-samples';
...
describe('RewardHistory Management Component', () => {
  let comp: RewardHistoryComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(RewardHistoryComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.rewardHistories?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
