...
import { sampleWithRequiredData } from '../like-history.test-samples';
...
describe('LikeHistory Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.likeHistories?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
